...
User map data is encoded into a compact URL hash. Copying the page URL preserves subdivision toggles, marked levels, and custom legend labels without a backend.
